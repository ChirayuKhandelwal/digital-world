    ...
    <div id="catalog" className="w-full">
      <div className="bg-alabaster border-b border-gray-200 pt-16 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-midnight mb-4">Products</h1>
      ...
      <motion.div 
        layout
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8 pt-12 pb-24"
      >
